...
-- SKIP: no string interning in Go -- do  -- reuse of long strings
-- SKIP: no string interning in Go -- 
-- SKIP: no string interning in Go --   -- get the address of a string
-- SKIP: no string interning in Go --   local function getadd (s) return string.format("%p", s) end
-- SKIP: no string interning in Go -- 
-- SKIP: no string interning in Go --   local s1 <const> = "01234567890123456789012345678901234567890123456789"
-- SKIP: no string interning in Go --   local s2 <const> = "01234567890123456789012345678901234567890123456789"
-- SKIP: no string interning in Go --   local s3 = "01234567890123456789012345678901234567890123456789"
-- SKIP: no string interning in Go --   local function foo() return s1 end
-- SKIP: no string interning in Go --   local function foo1() return s3 end
-- SKIP: no string interning in Go --   local function foo2()
-- SKIP: no string interning in Go --     return "01234567890123456789012345678901234567890123456789"
-- SKIP: no string interning in Go --   end
-- SKIP: no string interning in Go --   local a1 = getadd(s1)
-- SKIP: no string interning in Go --   assert(a1 == getadd(s2))
-- SKIP: no string interning in Go --   assert(a1 == getadd(foo()))
-- SKIP: no string interning in Go --   assert(a1 == getadd(foo1()))
-- SKIP: no string interning in Go --   assert(a1 == getadd(foo2()))
-- SKIP: no string interning in Go -- 
-- SKIP: no string interning in Go --   local sd = "0123456789" .. "0123456789012345678901234567890123456789"
-- SKIP: no string interning in Go --   assert(sd == s1 and getadd(sd) ~= a1)
-- SKIP: no string interning in Go -- end
