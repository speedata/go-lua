...
-- SKIP: no string interning in Go --   do     -- short strings are internalized
-- SKIP: no string interning in Go --     local s1 = string.rep("a", 10)
-- SKIP: no string interning in Go --     local s2 = string.rep("aa", 5)
-- SKIP: no string interning in Go --   assert(string.format("%p", s1) == string.format("%p", s2))
-- SKIP: no string interning in Go --   end
-- SKIP: no string interning in Go -- 
-- SKIP: no string interning in Go --   do     -- long strings aren't internalized
-- SKIP: no string interning in Go --     local s1 = string.rep("a", 300); local s2 = string.rep("a", 300)
-- SKIP: no string interning in Go --     assert(string.format("%p", s1) ~= string.format("%p", s2))
-- SKIP: no string interning in Go --   end
end
